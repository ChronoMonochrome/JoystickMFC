...
// JoystickMFC.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CJoystickMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CJoystickMFCApp

CJoystickMFCApp::CJoystickMFCApp()
{
...
// Единственный объект CJoystickMFCApp

CJoystickMFCApp theApp;


// инициализация CJoystickMFCApp

BOOL CJoystickMFCApp::InitInstance()
{
